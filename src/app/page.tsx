  ...
  return (
    <div>
      ...
      <section className="py-16 bg-gradient-to-b from-white to-gray-50 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-amber-50 text-amber-800 text-xs font-bold px-3 py-1 rounded-full mb-3 border border-amber-200">
              📚 Invoicing Guides
            </div>
            <h2 className="text-3xl font-bold text-gray-900">
              Learn Invoicing, Tax &amp; Payment Best Practices
            </h2>
            <p className="mt-3 text-gray-600 max-w-2xl mx-auto">
              Free in-depth guides covering invoice compliance, payment recovery, international
              clients, and country-specific tax rules. Read before you generate.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link
              ...
              className="group block bg-white rounded-2xl border border-gray-200 overflow-hidden hover:shadow-xl transition-all hover:-translate-y-1"
            >
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-gray-600 mt-3 leading-relaxed">
                  Step-by-step walkthrough of every required field, tax compliance, payment terms,
                  and the common mistakes that delay payments.
                </p>
                <p className="text-xs text-gray-400 mt-4 font-medium">12 min read →</p>
              </div>
            </Link>

            <Link
              href="/blog/invoice-international-clients-from-india"
              className="group block bg-white rounded-2xl border border-gray-200 overflow-hidden hover:shadow-xl transition-all hover:-translate-y-1"
            >
              ...
              <div className="p-6">
                ...
                <h3 className="text-lg font-bold text-gray-900 mt-2 group-hover:text-emerald-600 transition-colors">
                  Invoicing International Clients from India
                </h3>
                <p className="text-sm text-gray-600 mt-3 leading-relaxed">
                  GST LUT, FIRC, SWIFT codes, W-8BEN, and the full paper trail for receiving USD or
                  EUR from foreign clients into India.
                </p>
                <p className="text-xs text-gray-400 mt-4 font-medium">14 min read →</p>
              </div>
            </Link>

            <Link
              href="/blog/late-payment-recovery-india-freelancers"
              className="group block bg-white rounded-2xl border border-gray-200 overflow-hidden hover:shadow-xl transition-all hover:-translate-y-1"
            >
              ...
              <div className="p-6">
                ...
                <h3 className="text-lg font-bold text-gray-900 mt-2 group-hover:text-rose-600 transition-colors">
                  How to Recover Late Payments (India)
                </h3>
                <p className="text-sm text-gray-600 mt-3 leading-relaxed">
                  MSME Act protections, ODR portal, demand notice template, and the escalation path
                  when clients refuse to pay.
                </p>
                <p className="text-xs text-gray-400 mt-4 font-medium">11 min read →</p>
              </div>
            </Link>
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className="text-lg font-bold text-gray-900 mt-2 group-hover:text-orange-600 transition-colors">
                  GST Invoice India — Full Compliance
                </h3>
                <p className="text-sm text-gray-600 mt-3 leading-relaxed">
                  CGST/SGST/IGST split, HSN/SAC codes, place of supply, e-invoicing rules, and
                  filing requirements for small business.
                </p>
                <p className="text-xs text-gray-400 mt-4 font-medium">13 min read →</p>
              </div>
            </Link>
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className="text-lg font-bold text-gray-900 mt-2 group-hover:text-purple-600 transition-colors">
                  Send Invoices That Actually Get Paid On Time
                </h3>
                <p className="text-sm text-gray-600 mt-3 leading-relaxed">
                  Payment terms, follow-up cadence, and the language and timing that get clients to
                  pay without chasing.
                </p>
                <p className="text-xs text-gray-400 mt-4 font-medium">10 min read →</p>
              </div>
            </Link>
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className="text-lg font-bold text-gray-900 mt-2 group-hover:text-cyan-600 transition-colors">
                  Tax Invoice Requirements by Country
                </h3>
                <p className="text-sm text-gray-600 mt-3 leading-relaxed">
                  Required fields, tax IDs, and language rules for invoices across India, UK, US,
                  EU, Australia, Canada, and more.
                </p>
                <p className="text-xs text-gray-400 mt-4 font-medium">15 min read →</p>
              </div>
            </Link>
          </div>
